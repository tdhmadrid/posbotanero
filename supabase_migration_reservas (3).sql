...
ALTER TABLE pos_config
  ...
  ADD COLUMN IF NOT EXISTS res_horario        jsonb   DEFAULT '{
    "1": {"activo": true,  "desde": "13:00", "hasta": "23:00"},
    "2": {"activo": true,  "desde": "13:00", "hasta": "23:00"},
    "3": {"activo": true,  "desde": "13:00", "hasta": "23:00"},
    "4": {"activo": true,  "desde": "13:00", "hasta": "23:00"},
    "5": {"activo": true,  "desde": "13:00", "hasta": "23:30"},
    "6": {"activo": true,  "desde": "12:00", "hasta": "23:30"},
    "0": {"activo": false, "desde": "13:00", "hasta": "22:00"}
  }'::jsonb,
  ADD COLUMN IF NOT EXISTS res_intervalo_min  integer DEFAULT 30,
  ADD COLUMN IF NOT EXISTS res_antelacion_min integer DEFAULT 1,
...
-- Nota: res_horario usa día de la semana JS (0=domingo, 1=lunes ... 6=sábado)
-- Cada día tiene: activo (boolean), desde (HH:MM), hasta (HH:MM)
-- Ejemplo: lunes cerrado → "1": {"activo": false, ...}
